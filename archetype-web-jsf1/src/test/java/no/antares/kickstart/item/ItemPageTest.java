...
import static no.antares.kickstart.test.util.CustomAsserts.assertContains;

import java.util.List;

import no.antares.kickstart.test.pageobjects.ItemPage;
 ...
 * @author Tommy Skodje
 */
@RunWith(Parameterized.class) public class ItemPageTest {
	...
	public ItemPageTest(final SeleniumStarter seleniumIn) {
		selenium = seleniumIn;
	}
